...
# minimum_precipitation = fields.Int(attribute="mm", allow_none=True)
# maximum_precipitation = fields.Int(attribute="mm")
# minimum_temperature = fields.Int(attribute="deg_c")

# class MainSpiciesSchema(Schema):
#     bloom_months = fields.Pluck(GrowthSchema, "bloom_months", attribute="growth")
# maximum_precipitation = fields.Pluck(GrowthNestedSchema, "maximum_precipitation", allow_none=True, required=False)  #['Not a valid integer.']
# minimum_temperature = fields.Pluck(GrowthNestedSchema, "minimum_temperature
